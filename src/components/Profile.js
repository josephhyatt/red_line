			...
			db.collection("userInfo")
				...
				.then((doc) => {
					doc.forEach((user) => {
						...
						let favItem;
						if (this.state.data.favorites != undefined) {
							Object.keys(this.state.data.favorites).map(
								(fav) => (
									console.log(fav),
				...
				<>
					...
					<div className="profileform">
						...
						<input
							...
							placeholder={
								!!this.state.data ? this.state.data.firstName : "First Name"
							}
						/>
						...
						<input
							...
							placeholder={
								!!this.state.data ? this.state.data.lastName : "Last Name"
							}
						/>
						...
						<input
							...
							id="exampleInputPassword1"
							placeholder={
								!!this.state.data ? this.state.data.phoneNumber : "Phone Number"
							}
						/>
